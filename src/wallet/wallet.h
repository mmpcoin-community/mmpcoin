...
/*
 * mmpcoin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * mmpcoin: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * MmpCoin: Get a fee targetting a specific transaction speed.
     */

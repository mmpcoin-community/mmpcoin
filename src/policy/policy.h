 ...
 *
 *  mmpcoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * mmpcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * mmpcoin: Default hard dust limit that is evaluated when considering whether

...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the MmpCoin Core repository on GitHub"),
        tr("Services that claim to double your mmpcoin are always ponzi schemes")
    };

...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bellscoin-community/mmpcoin>";
    const std::string URL_WEBSITE = "<https://github.com/bellscoin-community/mmpcoin>";

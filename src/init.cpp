...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mmpcoin-community/mmpcoin>";
    const std::string URL_WEBSITE = "<https://github.com/mmpcoin-community/mmpcoin>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // mmpcoin: Do we need to do any RPC mining init here?

# Contributing to MmpCoin Core

MmpCoin Core is open source software, and we would welcome contributions
...
* [MmpCoindev on reddit](https://www.reddit.com/r/mmpcoindev/)

## Branch Strategy

MmpCoin Core's default branch is intentionally a stable release, so that anyone
...
MmpCoin Core is a direct fork of Bitcoin Core and therefore benefits from as

...
use "mmpcoind" you must run it the first time with the "-reindex" command line
option.
...
A problem in parsing mangled mmpcoin: URIs under Windows has been resolved, and as
part of this work network detection for mmpcoin: URIs is now more robust.
